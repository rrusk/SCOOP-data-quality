...
SQL_DIR="$HOME/mysql"
DB_USER=`cat $SQL_DIR/db_config/db_user`
DB_NAME=`cat $SQL_DIR/db_config/db_name`
DB_PASSWD=`cat $SQL_DIR/db_config/db_passwd`
DB_PORT=`cat $SQL_DIR/db_config/db_port`
