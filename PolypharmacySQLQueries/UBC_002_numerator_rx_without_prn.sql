...
this query counts  Prescriptions (not unique meds) per patient and only includes meds that have a DIN and ATC.  the query also excludes prn medications and excludes archived prescriptions 
